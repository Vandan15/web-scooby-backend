...
const { createOrder, getOrder, getProductDetail, uploadProductImage, updateProduct, deleteProduct, updateOrder, initRazorPay, verifyRazorPay, validateOrder } = require('../controllers/order');
